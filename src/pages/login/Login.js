        ...
        <Paper elevation={3} sx={{width: "30%", padding: 4, justifyContent: 'center'}}>
          <Stack sx={{justifyContent: 'center', alignItems: 'center'}}>
            <img src="/bklogo.jpeg" alt="Logo"
                 style={{height: 50, width: 90, paddingBottom: '1rem'}}/>
            <Typography color="#1b45a1" fontSize={30} fontWeight={550} sx={{paddingBottom: '2rem'}}>Login</Typography>
          </Stack>
          <Stack spacing={4}>
            <TextField
              fullWidth
                ...
                endAdornment={
                  <InputAdornment position="end">
                    <IconButton
                      ...
                      edge="end"
                    >
                      {password.trim() !== '' && (!showPassword ? <VisibilityOff/> : <Visibility/>)}
                    </IconButton>
                  </InputAdornment>
                }
                value={password}
